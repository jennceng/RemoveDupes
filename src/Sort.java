...
public class Sort {
    ...
    private static int removeDupes(int[] arr) {
        // k keeps track of the index we are inserting the next unique element
        int k = 1;
        ...
        // k is the index of the element after the last unique number, the equal of the subarray is the uniquecount, which will end up being equal to k.
        int uniqueCount = k;
...
//        printArray(copy);
          int[] alreadySorted = {2, 5, 5, 5, 10, 12, 12};
          int[] alreadySortedNoDupes = {2, 5, 10, 12};
          int[] zeros = {0, 0, 2, 5, 5, 5, 10, 12, 13};
//        System.out.println((removeDupes(alreadySorted)));
//        System.out.println(removeDupes(alreadySorted));
//          printArray(alreadySorted);

//          removeDupes(alreadySortedNoDupes);
//          printArray(alreadySortedNoDupes);
